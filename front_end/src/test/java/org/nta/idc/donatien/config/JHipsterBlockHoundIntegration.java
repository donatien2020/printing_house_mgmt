package org.nta.idc.donatien.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.nta.idc.donatien.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.nta.idc.donatien.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
