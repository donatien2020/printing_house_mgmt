...
export class NotificationUpdateComponent implements OnInit {
  ...
  notificationTypesValues = Object.keys(NotificationTypes);
  notificationProductsValues = Object.keys(NotificationProducts);
  notificationReceiversValues = Object.keys(NotificationReceivers);
