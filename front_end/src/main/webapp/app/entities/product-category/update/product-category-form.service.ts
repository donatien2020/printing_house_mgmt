...
type ProductCategoryFormGroupContent = {
  ...
  statu: FormControl<IProductCategory['statu']>;
  parentName: FormControl<IProductCategory['parentName']>;
  parent: FormControl<IProductCategory['parent']>;
};
...
export class ProductCategoryFormService {
  createProductCategoryFormGroup(productCategory: ProductCategoryFormGroupInput = { id: null }): ProductCategoryFormGroup {
    ...
    return new FormGroup<ProductCategoryFormGroupContent>({
      ...
      statu: new FormControl(productCategoryRawValue.statu, {
        validators: [Validators.required],
      }),
      parentName: new FormControl(productCategoryRawValue.parentName),
      parent: new FormControl(productCategoryRawValue.parent),
    });
  }
